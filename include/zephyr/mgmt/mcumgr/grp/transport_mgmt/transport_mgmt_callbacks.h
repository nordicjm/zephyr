...
#ifndef H_MCUMGR_TRANSPORT_MGMT_CALLBACKS_
#define H_MCUMGR_TRANSPORT_MGMT_CALLBACKS_
 ...
 * @defgroup mcumgr_callback_api_transport_mgmt Transport management callbacks
