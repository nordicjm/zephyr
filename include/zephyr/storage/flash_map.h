...
/** Deprecated macro, replace with PARTITION_EXISTS() */
...
#define FIXED_PARTITION_ID(label) PARTITION_ID(label)
// __DEPRECATED_MACRO
...
#define FIXED_PARTITION_OFFSET(label) PARTITION_OFFSET(label) 
...
#define PARTITION_ADDRESS(label)							\
	COND_CODE_1(DT_NODE_HAS_COMPAT(DT_NODELABEL(label), zephyr_mapped_partition),	\
		    (MAPPED_PARTITION_NODE_ADDRESS(DT_NODELABEL(label))),		\
		    (FIXED_PARTITION_NODE_ADDRESS(DT_NODELABEL(label))))

/** Deprecated macro, replace with PARTITION_ADDRESS() */
#define FIXED_PARTITION_ADDRESS(label) PARTITION_ADDRESS(label) 
//__DEPRECATED_MACRO
...
#define FIXED_PARTITION_NODE_ADDRESS(node) PARTITION_NODE_ADDRESS(node) 
//__DEPRECATED_MACRO
...
#define FIXED_PARTITION_NODE_OFFSET(label) PARTITION_NODE_OFFSET(label) 
//__DEPRECATED_MACRO
...
#define FIXED_PARTITION_SIZE(label) PARTITION_SIZE(label) 
//__DEPRECATED_MACRO
...
#define FIXED_PARTITION_NODE_SIZE(node) PARTITION_NODE_SIZE(node) 
//__DEPRECATED_MACRO
...
#define FIXED_PARTITION_DEVICE(label) PARTITION_DEVICE(label) 
//__DEPRECATED_MACRO
...
#define PARTITION_NODE_DEVICE(node)						\
	DEVICE_DT_GET(COND_CODE_1(DT_NODE_HAS_COMPAT(node,			\
...
#define FIXED_PARTITION_NODE_DEVICE(node) PARTITION_NODE_DEVICE(node) 
//__DEPRECATED_MACRO
...
/** Deprecated macro, replace with PARTITION_OFFSET() */
#define FIXED_PARTITION_MTD(label) PARTITION_MTD(label) 
//__DEPRECATED_MACRO
...
#define FIXED_PARTITION_NODE_MTD(node) PARTITION_NODE_MTD(node)
// __DEPRECATED_MACRO
...
#define PARTITION(label)								\
	COND_CODE_1(DT_NODE_HAS_COMPAT(DT_NODELABEL(label), zephyr_mapped_partition),	\
		    (MAPPED_PARTITION_BY_NODE(DT_NODELABEL(label))),			\
		    (FIXED_PARTITION_BY_NODE(DT_NODELABEL(label))))

/** Deprecated macro, replace with PARTITION() */
#define FIXED_PARTITION(label) PARTITION(label) 
//__DEPRECATED_MACRO
...
/** Deprecated macro, replace with PARTITION_OFFSET() */
#define FIXED_PARTITION_BY_NODE(node) PARTITION_BY_NODE(node) 
//__DEPRECATED_MACRO
