...
#define TEST_FLASH_0 DT_PATH(test, flash_0)
#define TEST_FLASH_1 DT_PATH(test, flash_10000000)

#define TEST_MAPPED_PARTITION_1 DT_PATH(test, flash_0, partition_0)
#define TEST_MAPPED_PARTITION_2 DT_PATH(test, flash_0, partition_c000)
#define TEST_MAPPED_PARTITION_3 DT_PATH(test, flash_0, partition_82000)
#define TEST_MAPPED_PARTITION_4 DT_PATH(test, flash_10000000, partitions, partition_f8000)
#define TEST_MAPPED_PARTITION_5 DT_PATH(test, flash_10000000, partitions, partition_f8000, \
					partition_0)
#define TEST_MAPPED_PARTITION_6 DT_PATH(test, flash_10000000, partitions, partition_f8000, \
					partition_0, partition_1000)
#define TEST_MAPPED_PARTITION_7 DT_PATH(test, flash_10000000, partitions, partition_f8000, \
					partition_3000)
#define TEST_DISABLED_MAPPED_PARTITION DT_PATH(test, flash_0, partition_89000)
...
{
	/* Test finding fixed partitions by the 'label' property. */
	zassert_false(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_0));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_1));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_1));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_2));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_3));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_4));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_5));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_6));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_7));
	zassert_true(DT_HAS_FIXED_PARTITION_LABEL(disabled_mapped_partition));

	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_1,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_1)));
	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_2,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_2)));
	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_3,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_3)));
	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_4,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_4)));
	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_5,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_5)));
	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_6,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_6)));
	zassert_true(DT_SAME_NODE(TEST_MAPPED_PARTITION_7,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_7)));
	zassert_true(DT_SAME_NODE(TEST_DISABLED_MAPPED_PARTITION,
				  DT_NODE_BY_FIXED_PARTITION_LABEL(disabled_mapped_partition)));

	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_1));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_2));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_3));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_4));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_5));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_6));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_MAPPED_PARTITION_7));
	zassert_true(DT_FIXED_PARTITION_EXISTS(TEST_DISABLED_MAPPED_PARTITION));

	/* There should not be a node with `label = "mapped-partition-8"`. */
	zassert_false(DT_HAS_FIXED_PARTITION_LABEL(mapped_partition_8));
	zassert_false(DT_NODE_EXISTS(DT_NODE_BY_FIXED_PARTITION_LABEL(mapped_partition_8)));

	/* Test DT_MTD_FROM_FIXED_PARTITION. */
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_1)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_2)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_3)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_4)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_5)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_6)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_7)));
	zassert_true(DT_NODE_EXISTS(DT_MTD_FROM_FIXED_PARTITION(TEST_DISABLED_MAPPED_PARTITION)));
	...
	zassert_true(DT_SAME_NODE(TEST_MTD_1, DT_MTD_FROM_FIXED_PARTITION(
	...
	/* Test DT_MEM_FROM_FIXED_PARTITION. */
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_1)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_2)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_3)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_4)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_5)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_6)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_MAPPED_PARTITION_7)));
	zassert_true(DT_NODE_EXISTS(DT_MEM_FROM_FIXED_PARTITION(TEST_DISABLED_MAPPED_PARTITION)));

	zassert_true(DT_SAME_NODE(TEST_FLASH_0, DT_MEM_FROM_FIXED_PARTITION(
							TEST_MAPPED_PARTITION_1)));
	zassert_true(DT_SAME_NODE(TEST_FLASH_0, DT_MEM_FROM_FIXED_PARTITION(
							TEST_MAPPED_PARTITION_2)));
	zassert_true(DT_SAME_NODE(TEST_FLASH_0, DT_MEM_FROM_FIXED_PARTITION(
							TEST_MAPPED_PARTITION_3)));
	zassert_true(DT_SAME_NODE(TEST_FLASH_1, DT_MEM_FROM_FIXED_PARTITION(
							TEST_MAPPED_PARTITION_4)));
	zassert_true(DT_SAME_NODE(TEST_FLASH_1, DT_MEM_FROM_FIXED_PARTITION(
							TEST_MAPPED_PARTITION_5)));
	zassert_true(DT_SAME_NODE(TEST_FLASH_1, DT_MEM_FROM_FIXED_PARTITION(
	...
	/* Test DT_FIXED_PARTITION_ADDR. */
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_1), 0x0);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_2), 0xc000);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_3), 0x82000);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_4), 0x100f8000);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_5), 0x100f8000);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_6), 0x100f9000);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_MAPPED_PARTITION_7), 0x100fb000);
	zassert_equal(DT_FIXED_PARTITION_ADDR(TEST_DISABLED_MAPPED_PARTITION), 0x89000);
