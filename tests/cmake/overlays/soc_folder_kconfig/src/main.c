...
#ifdef CONFIG_SOC_FOLDER_TEST_INCLUDE_SOC_QUALIFIERS
#define INCLUDED_SOC_QUALIFIERS 1
#else
#define INCLUDED_SOC_QUALIFIERS 0
#endif
...
#ifdef CONFIG_BOARD_NATIVE_SIM_NATIVE_64
	zassert_true(INCLUDED_SOC_QUALIFIERS, "Expected soc qualifier config to be present");
#else
	zassert_false(INCLUDED_SOC_QUALIFIERS,
		      "Did not expect soc qualifier config to be present");
#endif
