							 ...
							 bool save_if_single_setting)
{
	...
	if (next == NULL) {
		...
		/*
		 * Empty block as required by MISRA 15.7 which specifies that an if...else if...
		 * must end with an else, this is not used to prevent indentation of code below.
		 */
	}
	...
	if (rc >= 0) {
		...
		/*
		 * Empty block as required by MISRA 15.7 which specifies that an if...else if...
		 * must end with an else, this is not used because no further action is needed.
		 */
	}
