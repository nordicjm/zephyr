...
it, the files :file:`socs/<SOC>.conf` and :file:`socs/<SOC>_<BOARD_QUALIFIERS>.conf`
will be applied if they exist, after the main project configuration has been applied
and before any board overlay configuration files have been applied.
