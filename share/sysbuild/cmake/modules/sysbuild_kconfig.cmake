...
function(sb_soc_port_new prefix kconfig_fragment new_prefix out_file)
  # Parse the lines prefixed with 'prefix' in ${kconfig_fragment}
  file(
    STRINGS
    ${kconfig_fragment}
...
file(APPEND ${out_file} SB_${CMAKE_MATCH_0}=y\n)
#file(APPEND ${out_file} config\ ${VAR_VALUE}\n\tbool\n\n)
...
function(sb_soc_port_board prefix kconfig_fragment new_prefix out_file)
  # Parse the lines prefixed with 'prefix' in ${kconfig_fragment}
  file(
    STRINGS
    ${kconfig_fragment}
...
sb_soc_port_board(CONFIG_BOARD_ "${BOARD_DIR}/${BOARD}_defconfig" SB "${CMAKE_CURRENT_BINARY_DIR}/sb_soc.conf")
...
#  set(KCONFIG_ROOT ${ZEPHYR_BASE}/Kconfig_sysbuild)
  set(KCONFIG_ROOT /tmp/aa/zephyr/share/sysbuild/Kconfig)
#  set(KCONFIG_ROOT ${CMAKE_CURRENT_BINARY_DIR}/sb_soc.Kconfig)
endif()
include(${ZEPHYR_BASE}/cmake/modules/kconfig.cmake)
#include(${ZEPHYR_BASE}/cmake/modules/kconfig_sysbuild.cmake)
set(CONF_FILE)
