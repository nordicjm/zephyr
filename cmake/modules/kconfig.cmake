...
message(WARNING "list: ${ZEPHYR_SYSBUILD_MODULE_NAMES}")
  ...
  foreach(module_name ${ZEPHYR_SYSBUILD_MODULE_NAMES})
    ...
    list(APPEND
         ...
         "ZEPHYR_SYSBUILD_${MODULE_NAME_UPPER}_MODULE_DIR=${ZEPHYR_SYSBUILD_${MODULE_NAME_UPPER}_MODULE_DIR}"
    )

    if(ZEPHYR_${MODULE_NAME_UPPER}_KCONFIG)
      list(APPEND
           ZEPHYR_SYSBUILD_KCONFIG_MODULES_DIR
           "ZEPHYR_SYSBUILD_${MODULE_NAME_UPPER}_KCONFIG=${ZEPHYR_SYSBUILD_${MODULE_NAME_UPPER}_KCONFIG}"
    )
    endif()
  endforeach()
endif()
