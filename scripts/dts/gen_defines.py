...
def write_fixed_partitions(node: edtlib.Node) -> None:
    ...
    if not (node.parent and ("fixed-partitions" in node.parent.compats or "zephyr,xip-partitions" in node.parent.compats or "fixed-subpartitions" in node.parent.compats)):
        return
